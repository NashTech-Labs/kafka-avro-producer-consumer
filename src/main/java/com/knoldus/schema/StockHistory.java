...
public class StockHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static StockHistory.Builder newBuilder() {
   ...
   * @return A new StockHistory RecordBuilder
   */
  public static StockHistory.Builder newBuilder(StockHistory.Builder other) {
    return new StockHistory.Builder(other);
  }
   ...
   * @return A new StockHistory RecordBuilder
   */
  public static StockHistory.Builder newBuilder(StockHistory other) {
    return new StockHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StockHistory>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(StockHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(StockHistory other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.tradeId)) {
        this.tradeId = data().deepCopy(fields()[0].schema(), other.tradeId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder setTradeId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder clearTradeId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder setTradeQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder clearTradeQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder setTradeMarket(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder clearTradeMarket() {
      tradeMarket = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder setStockName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder clearStockName() {
      stockName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder setTradeType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder clearTradeType() {
      tradeType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder clearPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder setAmount(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public StockHistory.Builder clearAmount() {
